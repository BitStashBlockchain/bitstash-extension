...
import { MESSAGE_TYPE, RESPONSE_TYPE, BITSTASH_ACCOUNT_CHANGE } from '../../constants';
...
export default class SessionController extends IController {
  ...
  */
  public clearSession = () => {
    ...
    this.main.inpageAccount.sendInpageAccountAllPorts(BITSTASH_ACCOUNT_CHANGE.LOGOUT);
  }
