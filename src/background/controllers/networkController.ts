import { networks, Network } from 'bitstashjs-wallet';
...
export default class NetworkController extends IController {
  public static NETWORKS: QryNetwork[] = [
    new QryNetwork(NETWORK_NAMES.MAINNET, networks.mainnet, 'https://api.bitstash.co/bitstash-api/tx'),
    new QryNetwork(NETWORK_NAMES.TESTNET, networks.testnet, 'https://testnet.bitstash.co/tx'),
