      ...
      <div className={classes.root}>
        ...
        <div className={classes.contentContainer}>
          <div className={classes.inputContainer}>
            ...
            {this.props.store.sendStore.token && this.props.store.sendStore.token.symbol === 'STASH' ? (
              ...
              <div>
                ...
                <CostField fieldName={'Max Transaction Fee'} amount={maxTxFee} unit={'STASH'} {...this.props} />
              </div>
            )}
          </div>
