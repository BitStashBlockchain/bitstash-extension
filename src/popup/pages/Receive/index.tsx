...
class Receive extends Component<WithStyles & IProps, {}> {
  public render() {
    ...
    const { loggedInAccountName, info, bitstashBalanceUSD, networkBalAnnotation } = this.props.store.sessionStore;
      ...
      <div className={classes.root}>
        ...
        <div className={classes.contentContainer}>
          ...
          <div className={classes.amountContainer}>
            ...
            <Typography className={classes.token}>STASH</Typography>
          </div>
          <Typography className={classes.currencyValue}>{`${bitstashBalanceUSD} ${networkBalAnnotation}`}</Typography>
