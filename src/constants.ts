export enum TARGET_NAME {
  INPAGE = 'bitstash-inpage',
  CONTENTSCRIPT = 'bitstash-contentscript',
  BACKGROUND = 'bitstash-background',
}

export enum PORT_NAME {
  POPUP = 'bitstash-popup',
  CONTENTSCRIPT = 'bitstash-contentscript',
}
...
export enum API_TYPE {
  ...
  GET_INPAGE_BITSTASH_ACCOUNT_VALUES = 'GET_INPAGE_BITSTASH_ACCOUNT_VALUES',
  SEND_INPAGE_BITSTASH_ACCOUNT_VALUES = 'BITSTASH_ACCOUNT_CHANGED',
  CONNECT_INPAGE_BITSTASH = 'CONNECT_BITSTASH',
...
export enum MESSAGE_TYPE {
  ...
  GET_MAX_STASH_SEND = 'GET_MAX_STASH_SEND',
  GET_MAX_STASH_SEND_RETURN = 'GET_MAX_STASH_SEND_RETURN',
  GET_STASH_USD = 'GET_STASH_USD',
  GET_STASH_USD_RETURN = 'GET_STASH_USD_RETURN',
  ...
  GET_INPAGE_BITSTASH_ACCOUNT_VALUES = 'GET_INPAGE_BITSTASH_ACCOUNT_VALUES',
  SEND_INPAGE_BITSTASH_ACCOUNT_VALUES = 'SEND_INPAGE_BITSTASH_ACCOUNT_VALUES',
}
...
export enum BITSTASH_ACCOUNT_CHANGE {
  LOGIN = 'Account Logged In',
  LOGOUT = 'Account Logged Out',
  BALANCE_CHANGE = 'STASH Account Balance Changed',
