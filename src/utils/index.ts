...
import { validatePrivateKey } from 'bitstashjs-wallet';
...
/*
* Validates the Bitstash address based on length and starting character.
* @param isMainNet {boolean} Flag if is a mainnet address (or else testnet address).
* @param address {string} The Bitstash address to validate.
* @return {boolean} Returns if it is a valid Bitstash address.
*/
